...
Goal 5: To use a website that is both functional and aesthetically professional by ensuring that theming is consistent the website  is readable.
- **Design Ideas and Choices** _How will you meet those goals in your design?_
...
![Course landing page desktop](co1.jpg)
...
- Added links to the respective pages the headers represent: (About, Banner Headers and Course Overview Headers) so they can be clicked on.
- We made the course overview page have a button link to the course page directly on the course title
...
- Compared with other online-course websites, our website has a more vibrant but still clean color theme.
